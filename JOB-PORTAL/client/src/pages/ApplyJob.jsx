...
const ApplyJob = () => {
  ...
  return JobData  ? (
    <>
    <Navbar/>
    <div className="min-h-screen glex flex-col py-10 container px-4 2xl:px-20 mx-auto">
        ...
        {/*Job description section */}
          <div className="flex flex-col lg:flex-row justify-between items-start">
            ...
            <div className="w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5">
              ...
              {jobs.filter(job => job._id !== JobData._id && job.companyId._id === JobData.companyId._id).filter(job => true).slice(0,2)
